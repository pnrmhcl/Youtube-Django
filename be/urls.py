from be.views import get_channels_stats, get_playlist_video_id, get_channel_detail, get_video_details, get_comments, \
...
urlpatterns = [
    ...
    path('get-playlist-video-ids', get_playlist_video_id),
